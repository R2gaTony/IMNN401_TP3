...
class FloorMat : public MaterialGL
{
public:
	...
	*/
	FloorMat(string name = "", Texture2D* texture1 = nullptr, Texture2D* texture3 = nullptr);
...
protected:
	...
	GLuint l_View, l_Proj, l_Model, l_Time, l_PosLum, l_PosCam, l_TextureHandle1, l_TextureHandle3;
